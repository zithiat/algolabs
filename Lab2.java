...
class Lab2 {
  ...
  // Recursively generate the powerset (set of all subsets) of an array by
  // maintaining
  ...
  // Question 11
  // Iteractive algorithm for Fibonacci
  public static void fibonacci(int n) {
    ...
    System.out.format("Input number: %d, the Fibonacci value: %d", n, result);
  }
